...
public class JpaConfig {
  ...
  public DataSource dataSource() {
    ...
    String dbName = System.getenv().getOrDefault("DB_NAME", "microfinance_db");
    String dbUsername = System.getenv().getOrDefault("DB_USERNAME", "postgres");
    String dbPassword = System.getenv().getOrDefault("DB_PASSWORD", "localpass123");
    
    ds.setJdbcUrl(String.format("jdbc:postgresql://%s:%s/%s", dbHost, dbPort, dbName));
